...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updatePositionsAndScaling() {
        ...
        if (collectionArea) {
            ...
            updateCardArea(collectionArea, areaWidth, areaHeight, backgroundWidth, backgroundHeight);
        }
        if (deckArea) {
            ...
            updateCardArea(deckArea, areaWidth, areaHeight, backgroundWidth, backgroundHeight);
        }
