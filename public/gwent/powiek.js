...
function renderPowiek() {
    ...
    for (let i = -2; i <= 2; i++) {
        ...
        if (i === 0) {
            ...
            podsw.style.left = relW(-104) + 'px';
            podsw.style.top = relH(-10) + 'px';
            podsw.style.width = relW(523) + 'px';
            podsw.style.height = relH(992) + 'px';
            ...
            podsw2.style.left = relW(-104) + 'px';
            podsw2.style.top = relH(-10) + 'px';
            podsw2.style.width = relW(523) + 'px';
            podsw2.style.height = relH(992) + 'px';
        ...
        if (card.punkty !== undefined) {
            ...
            pointsDiv.style.top = relH(77) + 'px';
            pointsDiv.style.left = relW(76) + 'px';
            pointsDiv.style.width = relW(123) + 'px';
            pointsDiv.style.height = relH(88) + 'px';
            pointsDiv.style.fontSize = relW(44) + 'px';
        ...
        nameDiv.style.left = relW(113) + 'px';
        nameDiv.style.top = relH(766) + 'px';
        nameDiv.style.width = relW(518) + 'px';
        nameDiv.style.height = relH(111) + 'px';
        nameDiv.style.textAlign = 'center';
        nameDiv.style.fontSize = relW(44) + 'px';
        ...
        if (i === 0) {
            ...
            opisDiv.style.left = relW(9) + 'px';
            opisDiv.style.top = relH(879) + 'px';
            opisDiv.style.width = relW(514) + 'px';
            opisDiv.style.height = relH(991) + 'px';
            opisDiv.style.textAlign = 'center';
            opisDiv.style.color = '#fff';
            opisDiv.style.fontSize = relW(44) + 'px';
