...
function renderPowiek() {
    ...
    for (let i = -2; i <= 2; i++) {
        ...
        if (card.punkty !== undefined) {
            ...
            pointsDiv.style.top = percentH(77) + '%';
            pointsDiv.style.left = percentW(76) + '%';
            pointsDiv.style.width = percentW(123) + '%';
            pointsDiv.style.height = percentH(88) + '%';
    ...
    if (card0 && card0.moc) {
        ...
        infoBox.style.left = percentW(1356) + '%';
        infoBox.style.top = percentH(1661) + '%';
        infoBox.style.width = percentW(695) + '%';
        infoBox.style.height = percentH(202) + '%';
        ...
        mocIcon.style.left = percentW(1356 + 10) + '%';
        mocIcon.style.top = percentH(1661 + 10) + '%';
        mocIcon.style.width = percentW(64) + '%';
        mocIcon.style.height = percentH(64) + '%';
        ...
        mocName.style.left = percentW(1356) + '%';
        mocName.style.top = percentH(1735) + '%';
        mocName.style.width = percentW(695) + '%';
        mocName.style.textAlign = 'center';
        mocName.style.fontWeight = 'bold';
        mocName.style.fontSize = percentW(44) + '%';
        ...
        mocDesc.style.left = percentW(1356) + '%';
        mocDesc.style.top = percentH(1814) + '%';
        mocDesc.style.width = percentW(695) + '%';
        mocDesc.style.textAlign = 'center';
        mocDesc.style.fontSize = percentW(32) + '%';
