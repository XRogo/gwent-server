...
function renderPowiek() {
    ...
    for (let i = -2; i <= 2; i++) {
        ...
        if (i === 0) {
            ...
            podsw.style.left = ((-57/523)*100) + '%';
            podsw.style.top = ((-5/992)*100) + '%';
            podsw.style.width = ((575/523)*100) + '%';
            podsw.style.height = ((973/992)*100) + '%';
            ...
            podsw2.style.left = ((-57/523)*100) + '%';
            podsw2.style.top = ((-5/992)*100) + '%';
            podsw2.style.width = ((575/523)*100) + '%';
            podsw2.style.height = ((973/992)*100) + '%';
